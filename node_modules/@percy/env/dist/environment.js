  ...
  get branch() {
    ...
    let branch = (() => {
      ...
      switch (this.ci) {
        ...
        case 'github':
          return (_this$vars$GITHUB_REF = this.vars.GITHUB_REF) !== null && _this$vars$GITHUB_REF !== void 0 && _this$vars$GITHUB_REF.match(/^refs\//) ? this.vars.GITHUB_REF.replace(/^refs\/\w+?\//, '') : this.vars.GITHUB_REF;
